	...
	<div class="pcoded-inner-navbar main-menu">
		<div class="">
			<div class="main-menu-header">
				<c:if test="${not empty fotoUsuario}">
					<img class="img-80 img-radius" src="${fotoUsuario}"
					alt="User-Profile-Image">																	
				</c:if>
				
				<c:if test="${empty fotoUsuario}">
					<img class="img-80 img-radius" src="${pageContext.request.contextPath}/assets/images/free-user.png"
					alt="User-Profile-Image">
				</c:if>
			...
			<li class="pcoded-hasmenu"><a href="javascript:void(0)"
				...
				<ul class="pcoded-submenu">
					<c:if test="${perfil == 'ADMIN'}">
						<li class=" "><a href="<%= request.getContextPath() %>/ServletUsuarioController?acao=ListarUsers"
							class="waves-effect waves-dark"> <span class="pcoded-micon"><i
		...
		<ul class="pcoded-item pcoded-left-item">
			<li><a href="<%= request.getContextPath() %>/principal/rel.user.jsp"
				class="waves-effect waves-dark"> <span class="pcoded-micon"><i
